  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-20 w-full overflow-x-hidden bg-[#F2FAFB] text-[#003135] font-sans">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#003135] via-[#024950] to-[#003135] text-white pt-10 pb-20 sm:pt-16 sm:pb-28 lg:pt-20 lg:pb-32 border-b border-[#024950] shadow-inner">
        {/* Animated Glow Orbs */}
        <FloatingElement duration={6} distance={14} className="absolute top-8 left-1/4 w-72 h-72 bg-[#0FA4AF]/20 blur-[120px] rounded-full pointer-events-none" />
        <FloatingElement duration={8} distance={18} className="absolute bottom-10 right-1/4 w-96 h-96 bg-[#AFDDE5]/15 blur-[140px] rounded-full pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <FadeIn direction="down" delay={0.1}>
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#003135]/90 border border-[#0FA4AF]/50 text-[#AFDDE5] text-xs font-bold shadow-lg">
                  <Sparkles className="w-4 h-4 text-[#0FA4AF] shrink-0" />
                  <span className="tracking-wide">National Standard CBT Mock Testing & Exam Analytics</span>
                </div>
              </FadeIn>
              ...
              <FadeIn direction="up" delay={0.4}>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4 pt-2">
                  <Link
                    href="/tests"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-bold bg-[#964734] hover:bg-[#833B2B] text-white shadow-xl shadow-[#964734]/30 transition-all hover:scale-[1.03] text-sm"
                  >
                  ...
                  <Link
                    href="/courses"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-2xl font-bold bg-[#003135]/90 hover:bg-[#024950] text-[#AFDDE5] border border-[#0FA4AF]/40 transition-all hover:scale-[1.02] text-sm backdrop-blur-md shadow-lg"
                  >
              ...
              <FadeIn direction="up" delay={0.5}>
                <div className="grid grid-cols-3 gap-3 pt-2 text-[11px] text-[#AFDDE5]/80 font-medium">
                  <div className="flex items-center gap-1.5 justify-center lg:justify-start">
                    <ShieldCheck className="w-4 h-4 text-[#0FA4AF] shrink-0" />
                    <span>NTA CBT Standard</span>
                  </div>
                  <div className="flex items-center gap-1.5 justify-center lg:justify-start">
            ...
            <div className="lg:col-span-5 w-full">
              <FadeIn direction="left" delay={0.3}>
                <div className="relative rounded-3xl bg-white text-[#003135] border-2 border-[#0FA4AF]/40 p-5 sm:p-6 shadow-2xl w-full">
                  
                  {/* Simulator Header */}
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-3">
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-[#0FA4AF] animate-pulse" />
                      <span className="text-xs font-extrabold text-[#003135]">National CBT Exam Console</span>
                    </div>
                    <span className="px-2.5 py-1 rounded-lg bg-[#964734]/10 text-[#964734] text-xs font-mono font-bold border border-[#964734]/30 flex items-center gap-1">
                      <Clock className="w-3.5 h-3.5 text-[#964734]" /> 00:29:45
                    </span>
                  </div>

                  <div className="space-y-3 text-xs">
                    <div className="bg-[#AFDDE5]/25 p-3.5 rounded-2xl border border-[#0FA4AF]/25">
                      <div className="flex items-center justify-between text-[11px] text-[#024950] mb-1.5 font-bold">
                        <span>Question 03 of 30 • Physics</span>
                        <span className="text-[#0FA4AF] font-extrabold bg-white px-2 py-0.5 rounded-md border border-[#0FA4AF]/30 shadow-sm">+4 / -1 Mark</span>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 font-medium">
                        A) 16 meters
                      </div>
                      <div className="p-3 rounded-xl bg-[#0FA4AF]/15 border-2 border-[#0FA4AF] text-[#003135] font-bold flex items-center justify-between shadow-sm">
                    ...
                    {/* Feature Badges */}
                    <div className="pt-2 border-t border-slate-100 grid grid-cols-3 gap-2 text-center text-[10px] text-[#024950] font-bold">
                      <div className="p-2 bg-[#AFDDE5]/30 rounded-xl truncate">✓ Auto Grading</div>
                      <div className="p-2 bg-[#AFDDE5]/30 rounded-xl truncate">✓ Error Solutions</div>
                      <div className="p-2 bg-[#AFDDE5]/30 rounded-xl truncate">✓ Rank Estimator</div>
                    </div>
                  </div>
                </div>
              </FadeIn>
      ...
      {/* Institutional Stats Section with Animated CountUp */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 sm:-mt-16 relative z-20">
        <StaggerContainer staggerChildren={0.1} className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {stats.map((stat, i) => {
            const Icon = stat.icon;
            return (
              <StaggerItem key={i}>
                <HoverCard hoverY={-6}>
                  <div className="bg-white rounded-3xl p-5 sm:p-6 border border-[#AFDDE5]/70 shadow-xl shadow-[#024950]/5 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 hover:border-[#0FA4AF] transition-all">
                    <div className={`w-11 h-11 sm:w-13 sm:h-13 rounded-2xl flex items-center justify-center shrink-0 border ${stat.color}`}>
                      <Icon className="w-5 h-5 sm:w-6 sm:h-6" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-3xl font-black text-[#003135] tracking-tight">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        ...
        <StaggerContainer staggerChildren={0.15} className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <StaggerItem>
            <HoverCard hoverY={-6}>
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#AFDDE5]/60 shadow-sm hover:shadow-xl transition-all space-y-4 h-full">
                <div className="w-12 h-12 rounded-2xl bg-[#024950] text-[#AFDDE5] flex items-center justify-center shadow-sm">
          ...
          <StaggerItem>
            <HoverCard hoverY={-6}>
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#AFDDE5]/60 shadow-sm hover:shadow-xl transition-all space-y-4 h-full">
                <div className="w-12 h-12 rounded-2xl bg-[#0FA4AF]/15 text-[#0FA4AF] border border-[#0FA4AF]/30 flex items-center justify-center shadow-sm">
          ...
          <StaggerItem>
            <HoverCard hoverY={-6}>
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#AFDDE5]/60 shadow-sm hover:shadow-xl transition-all space-y-4 h-full">
                <div className="w-12 h-12 rounded-2xl bg-[#964734]/15 text-[#964734] border border-[#964734]/30 flex items-center justify-center shadow-sm">
      ...
      <section className="bg-[#AFDDE5]/20 py-16 sm:py-20 border-y border-[#AFDDE5]/50">
          ...
          <StaggerContainer staggerChildren={0.08} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockTests.map((test) => (
              <StaggerItem key={test.id}>
                <HoverCard hoverY={-5}>
                  <div className="bg-white rounded-3xl border border-[#AFDDE5]/70 shadow-sm hover:shadow-xl transition-all overflow-hidden flex flex-col justify-between group hover:border-[#0FA4AF] h-full">
                    <div className="p-6 space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="px-2.5 py-1 rounded-lg text-[11px] font-bold uppercase bg-[#AFDDE5]/30 text-[#024950] border border-[#AFDDE5]">
                          {test.category}
                        </span>
                        {test.isFree ? (
                    ...
                    <div className="p-6 pt-0">
                      <Link
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-bold text-xs bg-[#024950] hover:bg-[#003135] text-white transition-colors shadow-md group-hover:bg-[#964734]"
                      >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerContainer staggerChildren={0.1} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featuredCourses.map((course) => (
            <StaggerItem key={course.id}>
              <HoverCard hoverY={-6}>
                <div className="bg-white rounded-3xl border border-[#AFDDE5]/70 overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between h-full">
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer staggerChildren={0.1} className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {toppers.map((topper, i) => (
              <StaggerItem key={i}>
                <HoverCard hoverY={-5}>
                  <div className="bg-[#024950]/80 border border-[#0FA4AF]/30 rounded-3xl p-6 space-y-4 shadow-xl backdrop-blur-sm h-full">
      ...
      <section id="contact" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn direction="up">
          <div className="bg-white rounded-3xl border border-[#AFDDE5]/80 shadow-2xl overflow-hidden">
              ...
              <div className="lg:col-span-5 bg-gradient-to-br from-[#003135] to-[#024950] p-8 lg:p-12 text-white flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-[#024950]">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-4 text-xs sm:text-sm text-[#AFDDE5] font-medium">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-xl bg-[#003135] border border-[#0FA4AF]/40 flex items-center justify-center text-[#0FA4AF]">
